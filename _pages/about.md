...
======
1. **Liang Zhang**, Zhanrong Ou, Changhui Hu, Haibin Kan* and Jiheng Zhang. Data sharing in the metaverse with key abuse resistance based on decentralized CP-ABE. IEEE Transactions on Computers (CCF A), 2024, Accepted. [link](https://ieeexplore.ieee.org/abstract/document/10778270)
...
1. **Liang Zhang**,Xingyu Wu, Yuhang Ma and Haibin Kan*, Data exchange for the metaverse with accountable decentralized TTPs and incentive mechanisms, IEEE Transactions on Big Data (CCF C, JCR 1区), 2025, Accepted.
